...
<title>Experimental Data of Cascade Experiments in Genomics — CascadeData-package • CascadeData</title>
...
<li>
  <a href="../news/index.html">Changelog</a>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li>
  <a href="https://github.com/fbertran/CascadeData">
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Experimental Data of Cascade Experiments in Genomics</h1>
    
    <div class="hidden name"><code>cascade-package.rd</code></div>
    </div>
...
<tr><td>GNU 2.0</td><td></td></tr>
    ...
    <p>Vallat, L., Kemper, C. A., Jung, N., Maumy-Bertrand, M., Bertrand, F., ... &amp; Bahram, S. (2013). Reverse-engineering the genetic circuitry of a cancer cell with predicted intervention in chronic lymphocytic leukemia. <em>Proceedings of the National Academy of Sciences</em>, 110(2), 459-464.</p>
  ...
  <div class="col-md-3 hidden-xs hidden-sm" id="sidebar">
    ...
    <h2>Author</h2>
    <p>This package has been written by Frederic Bertrand, Myriam Maumy-Bertrand and Nicolas Jung with biological insights from Laurent Vallat.
Maintainer:  Frederic Bertrand &lt;frederic.bertrand@math.unistra.fr&gt;</p>
  </div>
</div>
